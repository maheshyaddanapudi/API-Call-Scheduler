...
import com.github.maheshyaddanapudi.quartz.scheduler.APICallsScheduler.dto.request.embedded.oauth2.admin.*;
...
@Tag(name = "OAuth2 Admin Actions", description = "The API provides the interface for adding / removing or updating clients, roles or users to database.")
public class OAuthAdminActionsRestController {
	
private Logger logger = LoggerFactory.getLogger(OAuthAdminActionsRestController.class.getSimpleName());
